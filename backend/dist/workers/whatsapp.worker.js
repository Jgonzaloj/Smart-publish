...
const orchestrator = new orchestrator_service_1.AgentOrchestrator();
exports.whatsappWorker = new bullmq_1.Worker('whatsappQueue', async (job) => {
    ...
    try {
        ...
        if (intent === orchestrator_service_1.AgentIntent.MARKETING_COMMAND) {
