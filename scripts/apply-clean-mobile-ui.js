...
body.theme-cream {
  ...
  --toolbar-bg: rgba(244, 239, 228, 0.88);
...
/* ------------------------------------------------------------
   7. KPI METRICS GRID (GLASSMORPHISM)
   ------------------------------------------------------------ */
.metrics-grid {
  display: grid;
...
/* ------------------------------------------------------------
   21. MÓVIL (<= 768px): DISEÑO ULTRA LIMPIO Y NATIVO
   ------------------------------------------------------------ */
@media (max-width: 768px) {
  /* TOP NAVBAR: 1 Sola fila compacta y elegante */
  .top-nav {
    padding: 8px 14px;
    height: 56px;
    display: flex;
  ...
  /* Ocultar elementos pesados de la barra superior en móvil */
  .status-indicator #network-status-text,
  .currency-switcher-box,
  .btn-logout-top,
  .btn-pwa-header,
  .btn-theme-toggle span:not(#theme-toggle-icon) {
    display: none !important;
  }
  ...
  /* Solo mostrar rol activo de forma compacta */
  .btn-role:not(.active) {
    display: none !important;
  }
  ...
  /* OCULTAR SUB-BARRA DE NAVEGACIÓN EN MÓVIL (Navegación nativa por Bottom Dock) */
  .nav-toolbar {
    display: none !important;
  }
  ...
  body.theme-cream .mobile-bottom-nav {
    ...
    box-shadow: 0 12px 36px rgba(36, 41, 46, 0.18);
  }
...
/* ------------------------------------------------------------
   22. EXTRA SMALL PHONES (< 380px: iPhone SE, Galaxy Mini)
   ------------------------------------------------------------ */
