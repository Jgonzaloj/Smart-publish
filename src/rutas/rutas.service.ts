    ...
    return this.prisma.withTenant(user.tenantId, async (tx) => {
      ...
      for (const c of clientes) {
        ...
        items.push({
          ...
          latitud: c.latitud ? Number(c.latitud) : (creditoActivo?.latitud ? Number(creditoActivo.latitud) : null),
          longitud: c.longitud ? Number(c.longitud) : (creditoActivo?.longitud ? Number(creditoActivo.longitud) : null),
          precisionGps: c.precisionGps ? Number(c.precisionGps) : (creditoActivo?.precisionGps ? Number(creditoActivo.precisionGps) : null),
