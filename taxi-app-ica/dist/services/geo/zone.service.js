...
export class ZoneService {
     ...
     */
    getZoneHeatMap() {
        const drivers = this.db.prepare("SELECT current_lat, current_lng FROM drivers WHERE status = 'online'").all();
        const pendingRides = this.db.prepare("SELECT origin_lat, origin_lng FROM rides WHERE status = 'REQUESTED'").all();
