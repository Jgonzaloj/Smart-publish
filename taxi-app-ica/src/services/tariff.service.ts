...
import { LocationPoint, TariffRule } from '../types/index.js';

export interface FareCalculationResult {
  recommended_fare: number;
  min_allowed_fare: number;
  max_suggested_fare: number;
  base_fare: number;
...
export class TariffService {
   ...
   */
  evaluateOfferProbability(offerFare: number, recommendedFare: number): OfferProbabilityResult {
   ...
   */
  updateTariffRule(newRules: Partial<TariffRule>): boolean {
